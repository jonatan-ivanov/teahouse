...
public class RuntimeInfoContributor implements InfoContributor {
    ...
    private Map<String, Object> javaInfo() {
        return ImmutableMap.<String, Object>builder()
            ...
            .put("runtime", ImmutableMap.builder()
                .put("name", System.getProperty("java.runtime.name"))
                .put("version", System.getProperty("java.runtime.version"))
                .build()
            )
            .put("vendor", ImmutableMap.builder()
                .put("name", System.getProperty("java.vendor"))
                .put("version", System.getProperty("java.vendor.version"))
                .build()
            )
            .put("vm", ImmutableMap.builder()
                .put("name", System.getProperty("java.vm.name"))
                .put("vendor", System.getProperty("java.vm.vendor"))
                .put("version", System.getProperty("java.vm.version"))
                .put("specification", ImmutableMap.builder()
                    .put("name", System.getProperty("java.vm.specification.name"))
                    .put("vendor", System.getProperty("java.vm.specification.vendor"))
                    .put("version", System.getProperty("java.vm.specification.version"))
                    .build()
                ).build()
            )
            .put("specification", ImmutableMap.builder()
                .put("name", System.getProperty("java.specification.name"))
                .put("vendor", System.getProperty("java.specification.vendor"))
                .put("version", System.getProperty("java.specification.version"))
                .build()
            )
