// Copied from https://github.com/wavefrontHQ/wavefront-spring-boot/blob/master/wavefront-spring-boot/src/main/java/com/wavefront/spring/autoconfigure/WavefrontSleuthSpanHandler.java
 ...
 * throw.
 */
public final class HackedWavefrontSleuthSpanHandler implements Runnable, Closeable {
    private static final Log LOG = LogFactory.getLog(HackedWavefrontSleuthSpanHandler.class);
    ...
    HackedWavefrontSleuthSpanHandler(int maxQueueSize, WavefrontSender wavefrontSender,
